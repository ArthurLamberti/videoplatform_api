...
import com.arthurlamberti.videoplataform.application.castmember.update.UpdateCastMemberOutput;
...
public class CastMemberAPITest {
    ...
    public void givenAValidId_whenCallsGetById_shouldReturnIt() throws Exception {
        ...
        when(getCastMemberByIdUseCase.execute(any()))
                .thenReturn(GetCastMemberByIdOutput.from(aMember));
    ...
    public void givenValidParams_whenCallListCastMembers_shouldReturnIt() throws Exception {
        ...
        final var expectedItems = List.of(ListCastMembersOutput.from(aMember));
